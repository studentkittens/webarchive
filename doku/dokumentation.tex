...
\part{Entwurf}
\input{./design/preview.tex}
\input{./design/misc/guidelines.tex}
\input{./design/data/data.tex}
\input{./design/backend/backend.tex}
\input{./design/frontend/frontend.tex}
\part{Implementierung}
\input{./impl/start.tex}
\input{./impl/frontend.tex}
\end{document}
