...
\paragraph{Beschreibung:}
\label{par:beschreibung_}
Gemäß \ref{req:filter} wird ein Filtersystem für gecrawlte Daten
implementiert.
...
\begin{itemize}
    \item \verb+[--archive]+, archive mode
    \item \verb+--delete]+, nicht mehr vorhandene Dateien werden im Zielverzeichnis gelöscht
    \item \verb+--checksum]+, Dateivergleich basiert auf Checksummen, nicht auf Änderungsdatum
\end{itemize}
