...
import archive.crawler.xmlgen as xmlgen
import archive.util.filelock as lock
import archive.crawler.git as git
import archive.crawler.exceptions as exceptions
import archive.crawler.dbgen as dbgen

from archive.dbrecover.pickle_recover import PickleDBRecover
from archive.crawler.rsync import rsync
    ...
    def start_crawl(self):
        ...
        while wget_proc.poll() is None:
            ...
            if self.__shutdown is True:
                ...
                wget_proc.stop()
                raise exceptions.ShutdownException()
